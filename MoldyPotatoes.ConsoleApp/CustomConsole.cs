...
namespace MoldyPotatoes.ConsoleApp
{
    ...
    //this is where we can "add" other languages
    public class CustomConsole : ICustomConsole
    {
        //Single responsibility
        //Methods that print things to the console. THE ONLY place where Console.Write/Read/Lines will go
        ...
        {
            Console.WriteLine("Stupid app anyway");
        }
    }
}